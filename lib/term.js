import { loginShellCommand, shellJoin } from "./shell.js";
...
export function kamalCommandLine(args) {
  return loginShellCommand(shellJoin(["kamal", ...args]));
}
...
export class KamalTerminal {
  ...
  run(args) {
    const line = kamalCommandLine(args) + "\r";
